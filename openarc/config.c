                  ...
                  char            **deprecated)
{
    ...
    while ((buf = config_getline(in)) != NULL)
    {
        ...
        if (p != NULL)
        {
            ...
            if (!err)
            {
                ...
                case CONFIG_TYPE_DEPRECATED:
                    ...
                    else
                    {
                        ...
                        if (new != NULL)
                        {
                            new[oldlen] = ',';
                            new[oldlen + 1] = '\0';
                            strlcat(new, def[n].cd_name, newlen);
                            *deprecated = new;
                        }
                    }
                    break;
                ...
                case CONFIG_TYPE_BOOLEAN:
                    if (p[0] == 't' || p[0] == 'T' || p[0] == 'y' ||
                        p[0] == 'Y' || p[0] == '1')
                    {
                        value = 1;
                    }
                    else if (p[0] == 'f' || p[0] == 'F' || p[0] == 'n' ||
                             p[0] == 'N' || p[0] == '0')
                    {
                        value = 0;
                    }
        ...
        case CONFIG_TYPE_INCLUDE:
        {
            ...
            incl = config_load_level(str, def, line, outpath, outpathlen,
                                     level + 1, deprecated);
            if (incl == NULL)
            {
                if (in != stdin)
